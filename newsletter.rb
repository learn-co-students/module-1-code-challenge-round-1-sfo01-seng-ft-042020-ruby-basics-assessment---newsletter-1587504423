...
def calculate_recipients
  ...
  new = SUBSCRIBERS + UNSUBSCRIBED
  new.uniq
  new.delete_if {|element| element == UNSUBSCRIBED[0]}
  new.delete_if {|element| element == UNSUBSCRIBED[1]}
  new
end
...
def format_campus_location(campus)
  "SUBJECT: Flatiron #{CAMPUS[:name]} Newsletter - #{DATE}"
end
